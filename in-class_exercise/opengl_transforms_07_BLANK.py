...
# Exercise 3: Construct a joint structure made of three components
def exercise3_jointAnim():
    # configure quatratic drawing
    quadratic = gluNewQuadric()
    gluQuadricDrawStyle(quadratic, GLU_FILL)
  

    # TODO: Create a yellow cylinder (base) and rotate it such that its main axis
    #       forms 30 degrees with the x-axis

    glColor3f(1.0, 1.0, 0.0)
    gluCylinder(quadratic, 3.0, 3.0, 10.0, 32, 32)


    # TODO: Create green sphere (joint) and transform it to be attached to the end of the 
    #       yellow cylinder
    ...
    # TODO: Create a turquoise cylinder (arm) and rotate it such that it's attached
    #       to the joint and form 60 degrees with the x-axis (or 30 degress with the base cylinder)

    glColor3f(0.50, 1.0, 1.0)
    gluCylinder(quadratic, 2.5, 2.5, 15.0, 32, 32)
...
def main():
    ...
    pygame.display.set_caption('CPSC 515 - OpenGL for Transforms')          # set title of the program window

...
def draw_mesh(obj, model_name): 
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, (0.8, 0.8, 0.8, 1.0))   # less shiny white
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, 128.0)                  # [0–128], higher = tighter highlight
...
def main():
    ...
    pygame.display.set_caption('CPSC 515: Lighting')                        # set title of the program window
    ...
    # load OBJ mesh
    model_name = "Car" # switch model here: "Car", "panther"
